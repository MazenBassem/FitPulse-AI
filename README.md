...
| Project Name | NutriScan AI – Nutrition Label Analyzer |
...
**NutriScan AI** is an intelligent nutrition label scanner and macro breakdown assistant. Designed to streamline dietary tracking, the application allows users to upload or scan images of physical food labels. By leveraging Large Language Models, it automatically extracts nutritional values (calories, macros, micronutrients) and inputs them into an interactive prompt interface to provide real-time dietary insights and personalized feedback.
...
*Dashboard preview and scanning workflow:*


*Figure 1: Main NutriScan AI interface*


*Figure 2: Nutrition label scan in action*

> *Note: Replace the image paths above with the actual file paths where you upload your dashboard screenshots in your repository (e.g., inside an `assets/` or `images/` folder).*
